...
const SEED = [
  // Science
  { id:"s01", author:"Trivia Bot", subject:"Science", question:"What planet is closest to the Sun?", answer:"mercury", ts: Date.now()-DAY*60 },
  { id:"s02", author:"Trivia Bot", subject:"Science", question:"What is the chemical symbol for gold?", answer:"au", ts: Date.now()-DAY*59 },
  { id:"s03", author:"Trivia Bot", subject:"Science", question:"How many bones are in the adult human body?", answer:"206", ts: Date.now()-DAY*58 },
  { id:"s04", author:"Trivia Bot", subject:"Science", question:"What gas do plants absorb from the atmosphere?", answer:"carbon dioxide", ts: Date.now()-DAY*57 },
  { id:"s05", author:"Trivia Bot", subject:"Science", question:"What is the hardest natural substance on Earth?", answer:"diamond", ts: Date.now()-DAY*56 },
  { id:"s06", author:"Trivia Bot", subject:"Science", question:"What planet is known as the Red Planet?", answer:"mars", ts: Date.now()-DAY*55 },
  { id:"s07", author:"Trivia Bot", subject:"Science", question:"What is the speed of light in miles per second (approximate)?", answer:"186000", ts: Date.now()-DAY*54 },
  { id:"s08", author:"Trivia Bot", subject:"Science", question:"What organ produces insulin in the human body?", answer:"pancreas", ts: Date.now()-DAY*53 },
  { id:"s09", author:"Trivia Bot", subject:"Science", question:"What is the most abundant gas in Earth's atmosphere?", answer:"nitrogen", ts: Date.now()-DAY*52 },
  { id:"s10", author:"Trivia Bot", subject:"Science", question:"How many chromosomes do humans have?", answer:"46", ts: Date.now()-DAY*51 },

  // History
  { id:"h01", author:"Trivia Bot", subject:"History", question:"In what year did World War II end?", answer:"1945", ts: Date.now()-DAY*50 },
  { id:"h02", author:"Trivia Bot", subject:"History", question:"Who was the first President of the United States?", answer:"washington", ts: Date.now()-DAY*49 },
  { id:"h03", author:"Trivia Bot", subject:"History", question:"In what year did the Berlin Wall fall?", answer:"1989", ts: Date.now()-DAY*48 },
  { id:"h04", author:"Trivia Bot", subject:"History", question:"Which ancient wonder was located in Alexandria?", answer:"lighthouse", ts: Date.now()-DAY*47 },
  { id:"h05", author:"Trivia Bot", subject:"History", question:"What year did the Titanic sink?", answer:"1912", ts: Date.now()-DAY*46 },
  { id:"h06", author:"Trivia Bot", subject:"History", question:"Who was the first man to walk on the moon?", answer:"neil armstrong", ts: Date.now()-DAY*45 },
  { id:"h07", author:"Trivia Bot", subject:"History", question:"In what year did World War I begin?", answer:"1914", ts: Date.now()-DAY*44 },
  { id:"h08", author:"Trivia Bot", subject:"History", question:"What empire was ruled by Julius Caesar?", answer:"roman", ts: Date.now()-DAY*43 },
  { id:"h09", author:"Trivia Bot", subject:"History", question:"What country did Napoleon Bonaparte come from?", answer:"france", ts: Date.now()-DAY*42 },
  { id:"h10", author:"Trivia Bot", subject:"History", question:"In what year did the American Civil War end?", answer:"1865", ts: Date.now()-DAY*41 },

  // Geography
  { id:"g01", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Australia?", answer:"canberra", ts: Date.now()-DAY*40 },
  { id:"g02", author:"Trivia Bot", subject:"Geography", question:"What is the longest river in the world?", answer:"nile", ts: Date.now()-DAY*39 },
  { id:"g03", author:"Trivia Bot", subject:"Geography", question:"What is the smallest country in the world?", answer:"vatican city", ts: Date.now()-DAY*38 },
  { id:"g04", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Canada?", answer:"ottawa", ts: Date.now()-DAY*37 },
  { id:"g05", author:"Trivia Bot", subject:"Geography", question:"On which continent is the Sahara Desert?", answer:"africa", ts: Date.now()-DAY*36 },
  { id:"g06", author:"Trivia Bot", subject:"Geography", question:"What is the tallest mountain in the world?", answer:"everest", ts: Date.now()-DAY*35 },
  { id:"g07", author:"Trivia Bot", subject:"Geography", question:"What ocean is the largest in the world?", answer:"pacific", ts: Date.now()-DAY*34 },
  { id:"g08", author:"Trivia Bot", subject:"Geography", question:"How many states does the United States have?", answer:"50", ts: Date.now()-DAY*33 },
  { id:"g09", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Japan?", answer:"tokyo", ts: Date.now()-DAY*32 },
  { id:"g10", author:"Trivia Bot", subject:"Geography", question:"What country has the most natural lakes in the world?", answer:"canada", ts: Date.now()-DAY*31 },

  // Pop Culture
  { id:"p01", author:"Trivia Bot", subject:"Pop Culture", question:"How many Harry Potter books are there?", answer:"7", ts: Date.now()-DAY*30 },
  { id:"p02", author:"Trivia Bot", subject:"Pop Culture", question:"What band was Freddie Mercury the lead singer of?", answer:"queen", ts: Date.now()-DAY*29 },
  { id:"p03", author:"Trivia Bot", subject:"Pop Culture", question:"What year was the first iPhone released?", answer:"2007", ts: Date.now()-DAY*28 },
  { id:"p04", author:"Trivia Bot", subject:"Pop Culture", question:"Who played Iron Man in the Marvel films?", answer:"robert downey jr", ts: Date.now()-DAY*27 },
  { id:"p05", author:"Trivia Bot", subject:"Pop Culture", question:"What is the best-selling video game of all time?", answer:"minecraft", ts: Date.now()-DAY*26 },
  { id:"p06", author:"Trivia Bot", subject:"Pop Culture", question:"What show features the fictional Dunder Mifflin Paper Company?", answer:"the office", ts: Date.now()-DAY*25 },
  { id:"p07", author:"Trivia Bot", subject:"Pop Culture", question:"How many seasons does Game of Thrones have?", answer:"8", ts: Date.now()-DAY*24 },
  { id:"p08", author:"Trivia Bot", subject:"Pop Culture", question:"Who sang Thriller?", answer:"michael jackson", ts: Date.now()-DAY*23 },
  { id:"p09", author:"Trivia Bot", subject:"Pop Culture", question:"What movie features the line 'You had me at hello'?", answer:"jerry maguire", ts: Date.now()-DAY*22 },
  { id:"p10", author:"Trivia Bot", subject:"Pop Culture", question:"What is the name of Batman's butler?", answer:"alfred", ts: Date.now()-DAY*21 },

  // Sports
  { id:"sp01", author:"Trivia Bot", subject:"Sports", question:"How many players are on a basketball team on the court?", answer:"5", ts: Date.now()-DAY*20 },
  { id:"sp02", author:"Trivia Bot", subject:"Sports", question:"How many rings does a perfect game in bowling require?", answer:"12", ts: Date.now()-DAY*19 },
  { id:"sp03", author:"Trivia Bot", subject:"Sports", question:"What country invented the sport of basketball?", answer:"united states", ts: Date.now()-DAY*18 },
  { id:"sp04", author:"Trivia Bot", subject:"Sports", question:"How many players are on a soccer team on the field?", answer:"11", ts: Date.now()-DAY*17 },
  { id:"sp05", author:"Trivia Bot", subject:"Sports", question:"How many holes are in a standard round of golf?", answer:"18", ts: Date.now()-DAY*16 },
  { id:"sp06", author:"Trivia Bot", subject:"Sports", question:"What sport is played at Wimbledon?", answer:"tennis", ts: Date.now()-DAY*15 },
  { id:"sp07", author:"Trivia Bot", subject:"Sports", question:"How many points is a touchdown worth in American football?", answer:"6", ts: Date.now()-DAY*14 },
  { id:"sp08", author:"Trivia Bot", subject:"Sports", question:"What country hosts the Tour de France?", answer:"france", ts: Date.now()-DAY*13 },

  // Math & Numbers
  { id:"m01", author:"Trivia Bot", subject:"Math", question:"What is the square root of 144?", answer:"12", ts: Date.now()-DAY*12 },
  { id:"m02", author:"Trivia Bot", subject:"Math", question:"What is 17 multiplied by 6?", answer:"102", ts: Date.now()-DAY*11 },
  { id:"m03", author:"Trivia Bot", subject:"Math", question:"How many sides does a hexagon have?", answer:"6", ts: Date.now()-DAY*10 },
  { id:"m04", author:"Trivia Bot", subject:"Math", question:"What is the value of Pi rounded to two decimal places?", answer:"3.14", ts: Date.now()-DAY*9 },
  { id:"m05", author:"Trivia Bot", subject:"Math", question:"What is 15% of 200?", answer:"30", ts: Date.now()-DAY*8 },

  // Literature
  { id:"l01", author:"Trivia Bot", subject:"Literature", question:"Who wrote Romeo and Juliet?", answer:"shakespeare", ts: Date.now()-DAY*7 },
  { id:"l02", author:"Trivia Bot", subject:"Literature", question:"Who wrote The Great Gatsby?", answer:"f scott fitzgerald", ts: Date.now()-DAY*6 },
  { id:"l03", author:"Trivia Bot", subject:"Literature", question:"What is the first book of the Bible?", answer:"genesis", ts: Date.now()-DAY*5 },
  { id:"l04", author:"Trivia Bot", subject:"Literature", question:"Who wrote 1984?", answer:"george orwell", ts: Date.now()-DAY*4 },
  { id:"l05", author:"Trivia Bot", subject:"Literature", question:"What detective was created by Arthur Conan Doyle?", answer:"sherlock holmes", ts: Date.now()-DAY*3 },

  // Food & Drink
  { id:"f01", author:"Trivia Bot", subject:"Food & Drink", question:"What is the main ingredient in guacamole?", answer:"avocado", ts: Date.now()-DAY*2 },
  { id:"f02", author:"Trivia Bot", subject:"Food & Drink", question:"What country does sushi originally come from?", answer:"japan", ts: Date.now()-DAY*1 },
  { id:"f03", author:"Trivia Bot", subject:"Food & Drink", question:"What is the world's most consumed beverage after water?", answer:"tea", ts: Date.now()-3600000 },
];
