...
const SEED = [
  // ── Science & Nature (20) ────────────────────────────────────────────────
  { id:"s01", author:"Trivia Bot", subject:"Science", question:"What planet is closest to the Sun?", answer:"mercury", ts: Date.now()-DAY*99 },
  { id:"s02", author:"Trivia Bot", subject:"Science", question:"What is the chemical symbol for gold?", answer:"au", ts: Date.now()-DAY*98 },
  { id:"s03", author:"Trivia Bot", subject:"Science", question:"How many bones are in the adult human body?", answer:"206", ts: Date.now()-DAY*97 },
  { id:"s04", author:"Trivia Bot", subject:"Science", question:"What gas do plants absorb from the atmosphere during photosynthesis?", answer:"carbon dioxide", ts: Date.now()-DAY*96 },
  { id:"s05", author:"Trivia Bot", subject:"Science", question:"What is the hardest natural substance on Earth?", answer:"diamond", ts: Date.now()-DAY*95 },
  { id:"s06", author:"Trivia Bot", subject:"Science", question:"What planet is known as the Red Planet?", answer:"mars", ts: Date.now()-DAY*94 },
  { id:"s07", author:"Trivia Bot", subject:"Science", question:"What organ in the human body produces insulin?", answer:"pancreas", ts: Date.now()-DAY*93 },
  { id:"s08", author:"Trivia Bot", subject:"Science", question:"What is the most abundant gas in Earth atmosphere?", answer:"nitrogen", ts: Date.now()-DAY*92 },
  { id:"s09", author:"Trivia Bot", subject:"Science", question:"How many chromosomes do humans have?", answer:"46", ts: Date.now()-DAY*91 },
  { id:"s10", author:"Trivia Bot", subject:"Science", question:"What is the chemical formula for water?", answer:"h2o", ts: Date.now()-DAY*90 },
  { id:"s11", author:"Trivia Bot", subject:"Science", question:"What force keeps planets in orbit around the Sun?", answer:"gravity", ts: Date.now()-DAY*89 },
  { id:"s12", author:"Trivia Bot", subject:"Science", question:"What is the powerhouse of the cell?", answer:"mitochondria", ts: Date.now()-DAY*88 },
  { id:"s13", author:"Trivia Bot", subject:"Science", question:"How many elements are on the periodic table?", answer:"118", ts: Date.now()-DAY*87 },
  { id:"s14", author:"Trivia Bot", subject:"Science", question:"What is the largest organ in the human body?", answer:"skin", ts: Date.now()-DAY*86 },
  { id:"s15", author:"Trivia Bot", subject:"Science", question:"What planet has the most moons in our solar system?", answer:"saturn", ts: Date.now()-DAY*85 },
  { id:"s16", author:"Trivia Bot", subject:"Science", question:"What is the atomic number of carbon?", answer:"6", ts: Date.now()-DAY*84 },
  { id:"s17", author:"Trivia Bot", subject:"Science", question:"What type of animal is a Komodo dragon?", answer:"lizard", ts: Date.now()-DAY*83 },
  { id:"s18", author:"Trivia Bot", subject:"Science", question:"How many chambers does the human heart have?", answer:"4", ts: Date.now()-DAY*82 },
  { id:"s19", author:"Trivia Bot", subject:"Science", question:"What planet is the largest in our solar system?", answer:"jupiter", ts: Date.now()-DAY*81 },
  { id:"s20", author:"Trivia Bot", subject:"Science", question:"What is the name of the layer of the atmosphere closest to Earth?", answer:"troposphere", ts: Date.now()-DAY*80 },

  // ── History (20) ─────────────────────────────────────────────────────────
  { id:"h01", author:"Trivia Bot", subject:"History", question:"In what year did World War II end?", answer:"1945", ts: Date.now()-DAY*79 },
  { id:"h02", author:"Trivia Bot", subject:"History", question:"Who was the first President of the United States?", answer:"george washington", ts: Date.now()-DAY*78 },
  { id:"h03", author:"Trivia Bot", subject:"History", question:"In what year did the Berlin Wall fall?", answer:"1989", ts: Date.now()-DAY*77 },
  { id:"h04", author:"Trivia Bot", subject:"History", question:"What year did the Titanic sink?", answer:"1912", ts: Date.now()-DAY*76 },
  { id:"h05", author:"Trivia Bot", subject:"History", question:"Who was the first human to walk on the moon?", answer:"neil armstrong", ts: Date.now()-DAY*75 },
  { id:"h06", author:"Trivia Bot", subject:"History", question:"In what year did World War I begin?", answer:"1914", ts: Date.now()-DAY*74 },
  { id:"h07", author:"Trivia Bot", subject:"History", question:"What country did Napoleon Bonaparte come from?", answer:"france", ts: Date.now()-DAY*73 },
  { id:"h08", author:"Trivia Bot", subject:"History", question:"In what year did the American Civil War end?", answer:"1865", ts: Date.now()-DAY*72 },
  { id:"h09", author:"Trivia Bot", subject:"History", question:"Who wrote the Declaration of Independence?", answer:"thomas jefferson", ts: Date.now()-DAY*71 },
  { id:"h10", author:"Trivia Bot", subject:"History", question:"What year did the French Revolution begin?", answer:"1789", ts: Date.now()-DAY*70 },
  { id:"h11", author:"Trivia Bot", subject:"History", question:"Which country was the first to give women the right to vote in 1893?", answer:"new zealand", ts: Date.now()-DAY*69 },
  { id:"h12", author:"Trivia Bot", subject:"History", question:"Who was the first female Prime Minister of the United Kingdom?", answer:"margaret thatcher", ts: Date.now()-DAY*68 },
  { id:"h13", author:"Trivia Bot", subject:"History", question:"What year did the United States declare independence?", answer:"1776", ts: Date.now()-DAY*67 },
  { id:"h14", author:"Trivia Bot", subject:"History", question:"What Egyptian queen had famous relationships with Julius Caesar and Mark Antony?", answer:"cleopatra", ts: Date.now()-DAY*66 },
  { id:"h15", author:"Trivia Bot", subject:"History", question:"What was the name of the first artificial satellite launched into space in 1957?", answer:"sputnik", ts: Date.now()-DAY*65 },
  { id:"h16", author:"Trivia Bot", subject:"History", question:"In what city was Martin Luther King Jr. assassinated in 1968?", answer:"memphis", ts: Date.now()-DAY*64 },
  { id:"h17", author:"Trivia Bot", subject:"History", question:"What year did the Soviet Union dissolve?", answer:"1991", ts: Date.now()-DAY*63 },
  { id:"h18", author:"Trivia Bot", subject:"History", question:"Who invented the telephone in 1876?", answer:"alexander graham bell", ts: Date.now()-DAY*62 },
  { id:"h19", author:"Trivia Bot", subject:"History", question:"What Roman structure was completed around 80 AD and could hold 50000 to 80000 spectators?", answer:"colosseum", ts: Date.now()-DAY*61 },
  { id:"h20", author:"Trivia Bot", subject:"History", question:"What ship was the first to circumnavigate the globe, completing the voyage in 1522?", answer:"victoria", ts: Date.now()-DAY*60 },

  // ── Geography (15) ───────────────────────────────────────────────────────
  { id:"g01", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Australia?", answer:"canberra", ts: Date.now()-DAY*59 },
  { id:"g02", author:"Trivia Bot", subject:"Geography", question:"What is the longest river in the world?", answer:"nile", ts: Date.now()-DAY*58 },
  { id:"g03", author:"Trivia Bot", subject:"Geography", question:"What is the smallest country in the world by area?", answer:"vatican city", ts: Date.now()-DAY*57 },
  { id:"g04", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Canada?", answer:"ottawa", ts: Date.now()-DAY*56 },
  { id:"g05", author:"Trivia Bot", subject:"Geography", question:"On which continent is the Sahara Desert located?", answer:"africa", ts: Date.now()-DAY*55 },
  { id:"g06", author:"Trivia Bot", subject:"Geography", question:"What is the tallest mountain in the world?", answer:"mount everest", ts: Date.now()-DAY*54 },
  { id:"g07", author:"Trivia Bot", subject:"Geography", question:"What is the largest ocean in the world?", answer:"pacific", ts: Date.now()-DAY*53 },
  { id:"g08", author:"Trivia Bot", subject:"Geography", question:"How many states does the United States have?", answer:"50", ts: Date.now()-DAY*52 },
  { id:"g09", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Japan?", answer:"tokyo", ts: Date.now()-DAY*51 },
  { id:"g10", author:"Trivia Bot", subject:"Geography", question:"What is the longest mountain range in the world?", answer:"andes", ts: Date.now()-DAY*50 },
  { id:"g11", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Brazil?", answer:"brasilia", ts: Date.now()-DAY*49 },
  { id:"g12", author:"Trivia Bot", subject:"Geography", question:"What is the largest country in the world by land area?", answer:"russia", ts: Date.now()-DAY*48 },
  { id:"g13", author:"Trivia Bot", subject:"Geography", question:"What river flows through Egypt?", answer:"nile", ts: Date.now()-DAY*47 },
  { id:"g14", author:"Trivia Bot", subject:"Geography", question:"What is the capital of Germany?", answer:"berlin", ts: Date.now()-DAY*46 },
  { id:"g15", author:"Trivia Bot", subject:"Geography", question:"What US state is the largest by land area?", answer:"alaska", ts: Date.now()-DAY*45 },

  // ── Pop Culture & Entertainment (15) ─────────────────────────────────────
  { id:"p01", author:"Trivia Bot", subject:"Pop Culture", question:"How many books are in the Harry Potter series?", answer:"7", ts: Date.now()-DAY*44 },
  { id:"p02", author:"Trivia Bot", subject:"Pop Culture", question:"What band was Freddie Mercury the lead singer of?", answer:"queen", ts: Date.now()-DAY*43 },
  { id:"p03", author:"Trivia Bot", subject:"Pop Culture", question:"What year was the first iPhone released?", answer:"2007", ts: Date.now()-DAY*42 },
  { id:"p04", author:"Trivia Bot", subject:"Pop Culture", question:"Who played Iron Man in the Marvel Cinematic Universe?", answer:"robert downey jr", ts: Date.now()-DAY*41 },
  { id:"p05", author:"Trivia Bot", subject:"Pop Culture", question:"What TV show features the fictional Dunder Mifflin Paper Company?", answer:"the office", ts: Date.now()-DAY*40 },
  { id:"p06", author:"Trivia Bot", subject:"Pop Culture", question:"How many seasons of Game of Thrones are there?", answer:"8", ts: Date.now()-DAY*39 },
  { id:"p07", author:"Trivia Bot", subject:"Pop Culture", question:"Who recorded the 1982 album Thriller?", answer:"michael jackson", ts: Date.now()-DAY*38 },
  { id:"p08", author:"Trivia Bot", subject:"Pop Culture", question:"What is the name of Batman's butler?", answer:"alfred", ts: Date.now()-DAY*37 },
  { id:"p09", author:"Trivia Bot", subject:"Pop Culture", question:"In what year was the first Star Wars film released?", answer:"1977", ts: Date.now()-DAY*36 },
  { id:"p10", author:"Trivia Bot", subject:"Pop Culture", question:"What streaming service produced Stranger Things?", answer:"netflix", ts: Date.now()-DAY*35 },
  { id:"p11", author:"Trivia Bot", subject:"Pop Culture", question:"Who voiced Woody in the Toy Story films?", answer:"tom hanks", ts: Date.now()-DAY*34 },
  { id:"p12", author:"Trivia Bot", subject:"Pop Culture", question:"What is the best-selling video game of all time?", answer:"minecraft", ts: Date.now()-DAY*33 },
  { id:"p13", author:"Trivia Bot", subject:"Pop Culture", question:"Who wrote and directed the 1994 film Pulp Fiction?", answer:"quentin tarantino", ts: Date.now()-DAY*32 },
  { id:"p14", author:"Trivia Bot", subject:"Pop Culture", question:"What fictional New Mexico high school teacher turned drug manufacturer stars in Breaking Bad?", answer:"walter white", ts: Date.now()-DAY*31 },
  { id:"p15", author:"Trivia Bot", subject:"Pop Culture", question:"Who played Jack Dawson in the 1997 film Titanic?", answer:"leonardo dicaprio", ts: Date.now()-DAY*30 },

  // ── Sports (10) ──────────────────────────────────────────────────────────
  { id:"sp01", author:"Trivia Bot", subject:"Sports", question:"How many players from one team are on a basketball court at a time?", answer:"5", ts: Date.now()-DAY*29 },
  { id:"sp02", author:"Trivia Bot", subject:"Sports", question:"How many players from one team are on a soccer field at a time?", answer:"11", ts: Date.now()-DAY*28 },
  { id:"sp03", author:"Trivia Bot", subject:"Sports", question:"How many holes are played in a standard round of golf?", answer:"18", ts: Date.now()-DAY*27 },
  { id:"sp04", author:"Trivia Bot", subject:"Sports", question:"What sport is played at Wimbledon?", answer:"tennis", ts: Date.now()-DAY*26 },
  { id:"sp05", author:"Trivia Bot", subject:"Sports", question:"How many points is a touchdown worth in American football?", answer:"6", ts: Date.now()-DAY*25 },
  { id:"sp06", author:"Trivia Bot", subject:"Sports", question:"In what country did the ancient Olympic Games originate?", answer:"greece", ts: Date.now()-DAY*24 },
  { id:"sp07", author:"Trivia Bot", subject:"Sports", question:"How many Grand Slam tennis tournaments are held per year?", answer:"4", ts: Date.now()-DAY*23 },
  { id:"sp08", author:"Trivia Bot", subject:"Sports", question:"What country has won the most FIFA World Cup titles?", answer:"brazil", ts: Date.now()-DAY*22 },
  { id:"sp09", author:"Trivia Bot", subject:"Sports", question:"How many innings are in a standard baseball game?", answer:"9", ts: Date.now()-DAY*21 },
  { id:"sp10", author:"Trivia Bot", subject:"Sports", question:"What sport uses terms like birdie, eagle, and bogey?", answer:"golf", ts: Date.now()-DAY*20 },

  // ── Math & Numbers (5) ───────────────────────────────────────────────────
  { id:"m01", author:"Trivia Bot", subject:"Math", question:"What is the square root of 144?", answer:"12", ts: Date.now()-DAY*19 },
  { id:"m02", author:"Trivia Bot", subject:"Math", question:"How many sides does a hexagon have?", answer:"6", ts: Date.now()-DAY*18 },
  { id:"m03", author:"Trivia Bot", subject:"Math", question:"What is the value of Pi rounded to two decimal places?", answer:"3.14", ts: Date.now()-DAY*17 },
  { id:"m04", author:"Trivia Bot", subject:"Math", question:"What is the only even prime number?", answer:"2", ts: Date.now()-DAY*16 },
  { id:"m05", author:"Trivia Bot", subject:"Math", question:"How many degrees are in a right angle?", answer:"90", ts: Date.now()-DAY*15 },

  // ── Literature (10) ──────────────────────────────────────────────────────
  { id:"l01", author:"Trivia Bot", subject:"Literature", question:"Who wrote Romeo and Juliet?", answer:"william shakespeare", ts: Date.now()-DAY*14 },
  { id:"l02", author:"Trivia Bot", subject:"Literature", question:"Who wrote The Great Gatsby?", answer:"f scott fitzgerald", ts: Date.now()-DAY*13 },
  { id:"l03", author:"Trivia Bot", subject:"Literature", question:"What is the first book of the Bible?", answer:"genesis", ts: Date.now()-DAY*12 },
  { id:"l04", author:"Trivia Bot", subject:"Literature", question:"Who wrote the dystopian novel 1984?", answer:"george orwell", ts: Date.now()-DAY*11 },
  { id:"l05", author:"Trivia Bot", subject:"Literature", question:"What fictional detective was created by Arthur Conan Doyle?", answer:"sherlock holmes", ts: Date.now()-DAY*10 },
  { id:"l06", author:"Trivia Bot", subject:"Literature", question:"Who wrote Pride and Prejudice?", answer:"jane austen", ts: Date.now()-DAY*9 },
  { id:"l07", author:"Trivia Bot", subject:"Literature", question:"Who wrote the epic poems the Iliad and the Odyssey?", answer:"homer", ts: Date.now()-DAY*8 },
  { id:"l08", author:"Trivia Bot", subject:"Literature", question:"What is the name of the hobbit hero in J.R.R. Tolkien's The Hobbit?", answer:"bilbo baggins", ts: Date.now()-DAY*7 },
  { id:"l09", author:"Trivia Bot", subject:"Literature", question:"Who wrote the play Death of a Salesman?", answer:"arthur miller", ts: Date.now()-DAY*6 },
  { id:"l10", author:"Trivia Bot", subject:"Literature", question:"What classic novel begins with the line: It was the best of times, it was the worst of times?", answer:"a tale of two cities", ts: Date.now()-DAY*5 },

  // ── Food & Drink (5) ─────────────────────────────────────────────────────
  { id:"f01", author:"Trivia Bot", subject:"Food & Drink", question:"What is the main ingredient in guacamole?", answer:"avocado", ts: Date.now()-DAY*4 },
  { id:"f02", author:"Trivia Bot", subject:"Food & Drink", question:"What country does sushi originally come from?", answer:"japan", ts: Date.now()-DAY*3 },
  { id:"f03", author:"Trivia Bot", subject:"Food & Drink", question:"What is the world's most consumed beverage after water?", answer:"tea", ts: Date.now()-DAY*2 },
  { id:"f04", author:"Trivia Bot", subject:"Food & Drink", question:"What nut is used to make marzipan?", answer:"almond", ts: Date.now()-DAY*1 },
  { id:"f05", author:"Trivia Bot", subject:"Food & Drink", question:"What country did the croissant originally come from before being popularized in France?", answer:"austria", ts: Date.now()-3600000 },
];
...
function checkAnswer(userAnswer, correctAnswer) {
  ...
  // Fuzzy match — allow 1 typo for short answers, 2 for longer ones
  const maxDist = ca.length <= 5 ? 1 : ca.length <= 10 ? 2 : 3;
